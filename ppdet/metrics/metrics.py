...
class VOCMetric(Metric):
    ...
    def update(self, inputs, outputs):
        ...
        scores = bbox_np[:, 1]
        labels = bbox_np[:, 0]
        # bboxes[:,0] = bboxes[:,0] *(640/2592)
        # bboxes[:,2] = bboxes[:,2] *(640/1944)
        # bboxes[:,1] = bboxes[:,1] *(640/2592)
        # bboxes[:,3] = bboxes[:,3] *(640/1944)
        #print(f"pre_boxes:{bboxes}")
        ...
        for i in range(len(gt_boxes)):
            ...
            #print(f"detection_map:{self.detection_map}")
